...
export default class Interactions {
    ...
    _onTouchMove(ev) {
        ...
        if (this._dragging) {
            ...
            const origDistance = Math.hypot(this._origZoomTouches[0].clientX - this._origZoomTouches[1].clientX, this._origZoomTouches[0].clientY - this._origZoomTouches[1].clientY);
            const distance = Math.hypot(ev.touches[0].clientX - ev.touches[1].clientX, ev.touches[0].clientY - ev.touches[1].clientY);
            this._pubsub.publish({
                type: "zoom",
