...
export default class Tangent {
  ...
  private readonly _T1: TangentPoint;
  private readonly _T2: TangentPoint;
  private readonly _a: Perpendicular;
  private readonly _b: Perpendicular;
  ...
  _controlPointChanged({ id, point }: { id: string; point: DOMPoint }) {
    ...
    const gradient =
      this._segment.gradient === undefined
        ? undefined
        : -1 / this._segment.gradient;
